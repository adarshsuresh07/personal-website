...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'The Wedding of Adarsh & Haseena',
            dates: `${formatDate('2026-02-28 16:00')}/${formatDate('2026-02-28 22:00')}`,
            details: 'You are cordially invited to celebrate the wedding of Adarsh & Haseena. Ceremony at 4:00 PM, Reception at 6:00 PM onwards. We look forward to celebrating this special day with you!',
            location: 'Green Nest Kumbalangi, Kochi',
            ctz: config.get('tz'),
        });
