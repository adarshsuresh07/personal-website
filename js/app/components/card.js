...
export const card = (() => {
    ...
    const renderBody = async (c) => {
        ...
        ${moreMaxLength ? `<p class="d-block mb-2 mt-0 mx-0 p-0"><a class="text-theme-auto" role="button" style="font-size: 0.85rem;" data-show="false" onclick="invitation.comment.showMore(this, '${c.uuid}')">Show more</a></p>` : ''}`;
    };
