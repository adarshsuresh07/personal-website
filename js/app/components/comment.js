...
export const comment = (() => {
     ...
     */
    const onNullComment = () => {
        return `<div class="text-center p-4 mx-0 mt-0 mb-3 bg-theme-auto rounded-4 shadow"><p class="fw-bold p-0 m-0" style="font-size: 0.95rem;">📢 Share this invitation to get more wishes! 🎉</p></div>`;
    };
    ...
    const showMore = (anchor, uuid) => {
        ...
        anchor.innerText = isCollapsed ? 'Show less' : 'Show more';
